<?php
    ...
    $sql2    = "SELECT kd_order FROM tb_order WHERE no_meja='$no_meja' AND user_kd='$usr'";
    ...
    <body style="background-color: #F2F2F2;">
        <div class="page-wrapper">
            <header class="header-desktop4">
                <div class="container">
                    <div class="header4-wrap">
                        <div class="header__logo">
                            <a href="#">
                                <img src="images/icon/logo-blue.png" alt="ME N U" />
                            </a>
                        </div>
                ...
                switch ($page) {
                case "order_menu";
                include "page/admin/order/order_menu.php";
                break;
                case "detail_menu":
                include "page/admin/order/detail_menu.php";
                break;
                default:
                $page = "dashboard";
                include "page/admin/order/dashboard.php";
                break;
                }
                ?>
